import { EmailProvider, EmailProviderName, EmailOptions } from './types';
...
/**
 * Send a generic email (e.g. for high-risk alerts).
 * Uses provider.sendEmail if available; otherwise no-op.
 */

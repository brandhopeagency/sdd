/**
 * Conversation Storage Types (Frontend)
 * 
 * These types define the structure for conversation data
 * including all technical details from Dialogflow CX.
 */
...
export interface StoredSystemPrompts {
  /**
   * Agent memory injected into Dialogflow (best-effort) for this turn.
   */
  agentMemorySystemMessages?: SystemPromptMessage[];
}
...
/**
 * User feedback stored with message
 */
export interface StoredMessageFeedback {
  rating: 1 | 2 | 3 | 4 | 5;
  comment: string | null;
...
export interface StoredMessage {
  ...
  // System prompts (debug/moderation)
  systemPrompts?: StoredSystemPrompts;

  // User feedback (stored form)
  feedback?: StoredMessageFeedback;
}

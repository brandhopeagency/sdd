...
// TODO: MessageBubble and TechnicalDetails need to be exported from chat-frontend-common or re-implemented
...
const TechnicalDetails = ({ message: _m, isExpanded: _e }: { message: any; isExpanded: boolean }) => (
  <div className="text-xs text-neutral-400">Technical details unavailable</div>
);
...
export default function ModerationView() {
  ...
  const handleSaveAnnotation = () => {
    if (!selectedSession || !canModerate || !hasMessages) return;
    saveAnnotation({
  ...
  return (
    <div className="h-full flex flex-col -m-6">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {!hasMessages && (
          <div className="mx-6 mt-6 card p-6 text-center text-neutral-600">
            <h2 className="text-lg font-semibold text-neutral-800">
              {t('moderation.empty.title', 'No messages in this session')}
            </h2>
            <p className="text-sm text-neutral-500 mt-2">
              {t('moderation.empty.description', 'Annotations are disabled until messages exist.')}
            </p>
          </div>
        )}
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {!hasMessages && (
              <div className="text-sm text-neutral-500 text-center py-6">
                {t('moderation.empty.transcript', 'No transcript messages available.')}
              </div>
            )}
            ...
            {selectedMessageId ? (
              <div>
                ...
                <textarea
                  ...
                  disabled={!hasMessages || !canModerate}
                />
        ...
        <div className="w-1/3 flex flex-col bg-white">
          ...
          <div className="p-4 border-t border-neutral-100 space-y-3">
            <button
              ...
              disabled={!canModerate || !hasMessages}
            >
            ...
            <button
              ...
              disabled={!canModerate || !hasMessages || selectedSession.moderationStatus === 'moderated'}

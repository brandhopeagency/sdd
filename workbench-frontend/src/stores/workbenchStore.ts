...
import type { User, Session, ChatMessage, Tag, Annotation, UserRole } from '@mentalhelpglobal/chat-types';
import { Permission } from '@mentalhelpglobal/chat-types';
import { usersApi, type UsersListParams, sessionsAdminApi, tagsAdminApi, type SessionsListParams } from '@/services/adminApi';
...
function storedConversationToChatMessages(conversation: import('@/services/adminApi').StoredConversation): ChatMessage[] {

      ...
      <main className="flex-1 flex items-center justify-center px-4 relative z-10">
        <div className="max-w-lg w-full text-center">
          ...
          <div className="mb-6 sm:mb-8 flex justify-center">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-primary-400 to-primary-500 rounded-2xl flex items-center justify-center shadow-soft-lg">
              <Heart className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
            </div>
          </div>

          {/* Title */}
          <h1 className="text-3xl sm:text-4xl font-bold text-neutral-800 mb-3 sm:mb-4">
            {t('app.name')}
          </h1>
          <p className="text-neutral-500 mb-8 sm:mb-10 max-w-md mx-auto leading-relaxed text-sm sm:text-base">
          ...
          <button
            ...
            className="btn-primary text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 rounded-xl shadow-soft-lg hover:shadow-soft transform hover:-translate-y-0.5 transition-all duration-300 w-full sm:w-auto"
          >
